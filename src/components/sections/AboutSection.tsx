  ...
  return (
    <section id="about" className="py-20 md:py-32 px-4 bg-white">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center animate-fadeIn">
          <div className="order-2 md:order-1">
            <h2 className="text-3xl md:text-4xl font-bold mb-8">О себе</h2>

            <p className="text-lg font-light mb-6 text-gray-800">
              Я графический дизайнер с более чем 5-летним опытом работы в сфере
              брендинга и айдентики. Моя страсть — создавать визуальные решения,
              которые помогают бизнесу выделиться и запомниться аудитории.
            </p>

            <p className="text-lg font-light mb-8 text-gray-800">
              Мой подход основан на минимализме, точности и внимании к деталям.
              Я верю, что лучший дизайн тот, который решает конкретную задачу
              наиболее элегантным способом.
            </p>
