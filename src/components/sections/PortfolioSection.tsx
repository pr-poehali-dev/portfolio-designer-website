...
const portfolioItems: PortfolioItem[] = [
  {
    ...
    year: "2023",
    description:
      "Разработка новой айдентики для сети кофеен, включая логотип, упаковку и маркетинговые материалы.",
    image:
      "https://images.unsplash.com/photo-1606744837616-56c9a5c6a6eb?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    category: "Брендинг",
  },
  {
    id: 2,
    ...
    year: "2022",
    description:
      "Дизайн и верстка каталога для ежегодной выставки современного искусства «Новые имена».",
    image:
      "https://images.unsplash.com/photo-1553531889-56cc480ac5cb?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    year: "2023",
    description:
      "Разработка веб-дизайна и прототипов для студии архитектуры, с фокусом на демонстрацию проектов.",
    image:
  ...
  },
  {
    ...
    year: "2022",
    description:
      "Создание системы визуальной идентификации для технологического стартапа.",
    image:
      "https://images.unsplash.com/photo-1534670007418-bc50e48fe71e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    category: "Айдентика",
  },
];
      ...
      <div className="container mx-auto">
        <div className="text-center mb-16 animate-fadeIn">
          ...
          <p className="text-lg font-light mt-4 max-w-2xl mx-auto text-gray-700">
            Избранные проекты, которые демонстрируют мой подход к дизайну и
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          {portfolioItems.map((item, index) => (
            <div
              key={item.id}
              className={`cursor-pointer group animate-fadeIn hover:-translate-y-1 transition-all duration-300 animation-delay-${index * 100}`}
            ...
            >
              ...
              <div className="mt-4">
                ...
                <p className="font-light text-gray-700 mt-2 line-clamp-2">
                  {item.description}
                </p>
              </div>
            </div>
          ...
          {selectedItem && (
            <div className="flex flex-col md:flex-row">
              ...
              <div className="md:w-1/3 p-6 flex flex-col">
                ...
                <p className="font-light text-gray-700 mt-4 flex-grow">
